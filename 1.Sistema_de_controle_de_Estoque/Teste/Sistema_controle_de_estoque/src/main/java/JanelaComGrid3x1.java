...
public class JanelaComGrid3x1 extends JFrame {
    ...
    private void exibirTabelaCMD() {
        ...
        try (Connection con = getConnection();
            ...
            //Formato de visualização da tabela quando for puxada, conforme os valores reais
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    //modelagem da tabela conforme as especificações a baixo
    ...
    private void salvarDados() {
        ...
        // puxando as colunas especificadas a baixo, utilizando comando SQL
